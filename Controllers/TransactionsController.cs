...
namespace PsychologicalCounseling.Controllers
{
    ...
    public class TransactionsController : ControllerBase
    {
        ...
        public TransactionsController(PsychologicalCouselingContext context)
        {
            _context = context;
        }

        // GET: api/Transactions
        [HttpGet("Getbookingtransbycustomerid")]
        public IActionResult GetBookingTransByCustomerid(int id)
        {
         //   string format = "dd/MM/yyyy";
            var result = (from s in _context.Transactions
                          where s.Wallet.CustomerId == id
                          select new
                          {
                              Id = s.Id,
