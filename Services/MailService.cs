...
namespace PsychologicalCounseling.Services
{
    public class MailService : IMailService
    {
        ...
        public async Task SendMail(MailRequest mailContent)
        {
            ...
            email.Sender = new MailboxAddress("Psychological Counseling System", "fptpsycteam@gmail.com");
            email.From.Add(new MailboxAddress("Psychological Counseling System", "fptpsycteam@gmail.com"));
